...
This application will be tracking our progress through Rails training.  Pretty sweet huh?
...
1. rails generate resource Article
2. Edit db/migrate/CreateArticle to include:
...
3. Add some gems to Gemfile to make our lives easier:
	
	gem 'inherited_resources'
	gem 'simple_form'

4. Update ~/app/controllers/articles_controller.rb to inherit from InheritedResources 
	
	class ArticlesController < InheritedResources::Base
		...
	end
5. Generate some basic views!
	
	Steal these from https://github.com/jordantcox/com.phantomdata.BillMinder and update to meet your needs.
